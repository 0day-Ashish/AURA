...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("https://aura-ceoi.onrender.com/auth/signup", {
        method: "POST",
        headers: {
      ...
      <div style={{ 
        ...
        <div style={{ 
            ...
            <div style={{ width: '100%', maxWidth: '600px' }}>
                <DotLottieReact
      src="https://lottie.host/6ea6fe0b-beb9-4b90-a3d2-4eaadc2154a2/fgjU2xNsgk.lottie"
      loop
      autoplay
    />
            </div>
        ...
        <div style={{ 
            ...
            <div style={{ 
                ...
                <h2 className="heading" style={{ color: 'white', marginBottom: '30px', fontSize: '2rem', textAlign: 'center' }}>Create Account</h2>
                
                <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                    <div>
                        <label style={{ display: 'block', color: 'rgba(255,255,255,0.7)', marginBottom: '8px', fontSize: '0.9rem' }}>Name</label>
                        <input 
                            type="text" 
                    ...
                    <div>
                        <label style={{ display: 'block', color: 'rgba(255,255,255,0.7)', marginBottom: '8px', fontSize: '0.9rem' }}>Confirm Password</label>
                        <div style={{ position: 'relative' }}>
                            <input 
                    ...
                    <div style={{ textAlign: 'center', marginTop: '10px' }}>
                        <span style={{ color: 'rgba(255,255,255,0.5)', fontSize: '0.9rem' }}>Already have an account? </span>
                        <Link href="/login" style={{ color: '#8A5CFF', textDecoration: 'none', fontWeight: 600, fontSize: '0.9rem' }}>Login</Link>
                    </div>
                </form>
            </div>
        </div>
